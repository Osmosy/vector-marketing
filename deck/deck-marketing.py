...
DATA = dict(
    ...
    chips=[('19', 'агентов'), ('160', 'навыков'), ('40', 'PM-методик')],
    ...
    layers_items=[
        ...
        ('Harness — что позволяет действовать', 'agents/*.md (19 ролей) + Hermes profile + 160 навыков в 8 наборах + MCP-инструменты: Яндекс Метрика/Директ API, MPSTATS, ДaData, Wordstat, карты'),
    ...
    # 10 · Roadmap
    roadmap_items=[
        ('Сейчас', ['40 PM-скиллов в 4 группах, 19 агентов, 160 навыков', 'Живая архитектурная диаграмма (Archify) + визуальная верификация']),
