...
DATA = dict(
    ...
    layers_items=[
        ...
        ('Harness — что позволяет действовать', 'agents/*.md (19 ролей) + Hermes profile + 161 навык в 8 наборах + MCP-инструменты: Яндекс Метрика/Директ API, MPSTATS, ДaData, Wordstat, карты'),
