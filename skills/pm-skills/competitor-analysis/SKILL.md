...
### Источники конкурентной разведки для рынка РФ (адаптация Vector Marketing)

Заменяет generic web research для российских рынков — идите в источники, где конкуренты оставляют фактические следы:

- **Реклама:** библиотека объявлений Яндекс.Директ (реальные креативы, офферы, посадочные конкурента), VK/Telegram Ads — виден ли активный платный трафик
- **Маркетплейсы:** MPSTATS/Moneyplace — выручка, цены, число SKU и продавцов, динамика категории конкурента (WB/Ozon)
- **Классифайды:** Авито — количество объявлений, тарифы продвижения, цены
- **SEO/контент:** видимость в Яндексе/Google, частота контента в Telegram-канале и соцсетях (реальная активность, а не заявленная)
- **Отзывы:** Яндекс.Карты, 2ГИС, отзовики, отзывы на маркетплейсах — боли клиентов конкурентов (топ-жалобы = ваши дифференциаторы)
- **Юридический след:** ДaData — выручка, численность, ОКВЭД, госконтракты; судебные дела (kad.arbitr.ru)

Правило: цифры конкурента из открытых источников = оценка, не факт. Помечать источник и допущения для каждой цифры.
