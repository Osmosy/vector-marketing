...
---
### Применимость в РФ (адаптация Vector Marketing)

Из 7 GTM-мотивов реально работают на российском рынке: Paid Digital (Директ/VK/TG Ads), Inbound (SEO/TG-контент), Partners (интеграции с TG-каналами и блогерами), Outbound (B2B через ДaData-рекрутинг). ABM — для enterprise-сегмента B2B. PLG и Community-мотивы — только для продуктовых компаний, для агентских клиентов чаще нерелевантны. Не навязывайте мотив: сначала объём спроса в Wordstat и тип клиента, потом мотив.
