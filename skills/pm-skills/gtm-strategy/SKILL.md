...
---
### Каналы вывода для рынка РФ (адаптация Vector Marketing)

При построении GTM-плана для российского рынка используйте канальную матрицу Vector:

- **Paid:** Яндекс.Директ (поиск + РСЯ), VK Ads, Telegram Ads, Авито-продвижение, внутренние тарифы WB/Ozon
- **Органика:** SEO (Яндекс приоритет), Telegram-канал ниши, отзовики и карты (Яндекс.Карты, 2ГИС, Flamp)
- **Маркетплейсы:** SEO карточки + продвижение в поиске WB/Ozon + внешние лиди через Директ на карточку
- **Партнёрства:** TG-чаты и блогеры ниши (закупка интеграций), CPА-сети
- **Wordstat-объём** как верхнеуровневая оценка спроса перед выбором каналов: нет объёма запросов — нет paid-канала

Метрики запуска в РФ: CPL по каналам, ДРР (доля рекламных расходов), конверсия карточки/лендинга, число отзывов за первый месяц.
