...
### Источники данных для рынка РФ (адаптация Vector Marketing)

- **Спрос в запросах:** Яндекс Wordstat (не Google Trends — для РФ нерепрезентативен). Учитывать минус-слова, регионы, сезонность за 2 года
- **Маркетплейсы:** MPSTATS / Moneyplace — выручка категорий, число продавцов, продажи SKU (оценка объёма сегмента «в деньгах» снизу)
- **Компании и выручка:** ДaData (справочники компаний, ОКВЭД, выручка), Росстат / ЕМИСС (отраслевая статистика), СПАРК/Контур.Фокус (при наличии доступа)
- **Рекламные рынки:** Яндекс и VK публикуют отчёты по объёмам интернет-рекламы; iRussia / АРИР — обзорные цифры рынка
- **Валюта:** все оценки — в рублях; для сравнения с зарубежными данными указывать ППС, а не рыночный курс
