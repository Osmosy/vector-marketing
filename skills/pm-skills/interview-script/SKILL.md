...
## Адаптация Vector Marketing: формат интервью для РФ-рынка

- **Каналы:** телефон и Telegram-голосовые — основной формат глубинных интервью для B2C-сегментов РФ; личные встречи — для B2B/enterprise. Не настаивайте на видео: часть респондентов откажется из-за камеры
- **Запись и цитаты:** запись — только с явного согласия в начале (и в конце — «можно ли использовать цитату без имени»). Цитату в отчёте давать ТОЛЬКО если она подтверждена транскриптом — вербатим-цитаты нельзя выдумывать или «улучшать»
- **Дистанционный рекрутинг:** TG-чаты ниши, Wordstat-аудитории, клиентские чаты конкурентов — рекрутинг через опрос с фильтром-скринером
- **Компенсация:** денежная (Яндекс.Деньги/перевод) — укажите сумму в приглашении; это резко повышает show-up rate
- **Легенда без продаж:** как в Mom Test — интервьюер НЕ продаёт. Фразы «мы разрабатываем…» — триггер вежливой лжи респондента
