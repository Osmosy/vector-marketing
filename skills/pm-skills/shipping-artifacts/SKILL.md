...
Скилл заимствован из [PM Skills Marketplace](https://github.com/phuryn/pm-skills) (MIT, куратор Павел Хурын, The Product Compass). Используется агентом ops/landing-cro экосистемы Vector Marketing.
