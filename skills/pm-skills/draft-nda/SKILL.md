...
### РФ-адаптация: NDA по праву РФ (Vector Marketing)

Для российских контрагентов NDA оформляется через режим **коммерческой тайны** (ФЗ-98 «О коммерческой тайне») и гл. 75 ГК РФ, а не через generic-конфиденциальность:

- **Режим КТ (ст. 10 ФЗ-98):** конфиденциальность возникает только при фактическом принятии мер — гриф «Коммерческая тайна», перечень сведений, приказ/положение о КТ, ограничение доступа. NDA без этих мер юридически слаб
- **Основание в ГК:** гл. 75 ГК РФ (служебная и коммерческая тайна) — ссылаться в договоре, а не на иностранные доктрины NDA
- **Перечень сведений:** конкретно перечислить (доступы к кабинетам Яндекса/VK/метрик, CRM-данные, бюджетные данные, клиентские базы) — формулировка «любая информация» неисполнима
- **Срок режима:** у коммерческой тайны нет автоматического срока — указать в договоре (обычно 3-5 лет после прекращения отношений)
- **Ответственность:** не «liquidated damages» (это US-конструкция) — убытки/неустойка по ГК; реально взыскать компенсацию за разглашение КТ можно только при доказанном режиме
- **Госнарушения ≠ КТ:** сведения, обязательные к раскрытию по закону, не могут быть КТ (ст. 5 ФЗ-98)
- **Подсудность и применимое право:** арбитраж (для юрлиц/ИП), место — по адресу агентства; третейская оговорка по желанию
- **Доступы к кабинетам:** отдельным пунктом — передача паролей/API-ключей рекламных кабинетов ≠ передача права собственности; отзыв доступа — односторонний и немедленный

[⚠️ LEGAL REVIEW REQUIRED] Все NDA перед подписанием — проверка юристом.
...
Скилл заимствован из [PM Skills Marketplace](https://github.com/phuryn/pm-skills) (MIT, куратор Павел Хурын, The Product Compass). Адаптация для права РФ — Vector Marketing.
