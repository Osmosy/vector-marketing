...
- **skills/yandex-wordstat** — семантика по реальному спросу: частотность (30 дней), ассоциации, сезонность, гео по РФ; скрипт `scripts/wordstat.py` (нужны `WORDSTAT_API_KEY`, `WORDSTAT_FOLDER_ID` — см. KEYS.md)
