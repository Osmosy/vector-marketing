...
оркестратор Osmosy), 159 навыков, 7 файлов общего контекста (Company Brain).
...
- Навыки — `skills/` (159; вендоренные наборы с атрибуцией в `NOTICE.md`)
...
|-----|---------|
| Агенты | 19 (`agents/`) |
| Навыки | 159 (`skills/`), из них 154 из сторонних наборов |
