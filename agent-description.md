...
оркестратор Osmosy), 160 навыков, 7 файлов общего контекста (Company Brain).
...
- Навыки — `skills/` (160; вендоренные наборы с атрибуцией в `NOTICE.md`)
...
|-----|---------|
| Агенты | 19 (`agents/`) |
| Навыки | 160 (`skills/`), из них 154 из сторонних наборов |
