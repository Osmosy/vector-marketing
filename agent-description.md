...
оркестратор Osmosy), 161 навык, 8 файлов общего контекста (Company Brain).
...
- Навыки — `skills/` (161; вендоренные наборы с атрибуцией в `NOTICE.md`)
...
- Правила правок и границы безопасности — `CONTRIBUTING.md`, `SECURITY.md`
...
|-----|---------|
| Агенты | 19 (`agents/`) |
| Навыки | 161 (`skills/`), из них 154 из сторонних наборов |
| Company Brain | 8 файлов (`company-brain/`) |
